...
public class GenotypeVariants implements FlatMapFunction<Iterator<VariantContext>,String> {
    ...
    String[] args;
    DriverBC dBC;
    public GenotypeVariants(GenomeLocation region, String[] args, String outputBP, HashMap<String, String> confMap,
    ...
    @Override public Iterator<String> call(Iterator<VariantContext> tupleIterator) throws
            Exception {
...
//        }
        ...
        for(Integer iter:bps) {
            VariantContext variantContext = engine.variantCallingForSpark(tupleIterator,
